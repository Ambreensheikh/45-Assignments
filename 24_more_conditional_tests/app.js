...
console.log("is van !== 'toyota'? i predict false"); //false
console.log(van !== 'toyota');
// test 5  equality with lowerCase
let book = 'the journey';
console.log("is book.tolowerCase() == 'the journey' ?I predict true"); //true
console.log(book.toLowerCase() == 'the journey');
//test 6 inequality with lowerCase
console.log("is book === 'the journey.tolowerCase()'? I predict false"); //false
console.log(book === 'the journey.tolowerCase()');
...
console.log("is 2 in numbers  ? I predict true"); //true
